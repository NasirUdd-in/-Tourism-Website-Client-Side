...
const Admin = () => {
    ...
    // const [allBookings, setAllBookings] = useState([]);
    useEffect(() => {
        fetch("https://arcane-headland-51224.herokuapp.com/booking")
            .then((res) => res.json())
            .then((data) => {
                setAllBookings(data);
                // console.log(data);
    ...
    const handleDelete = (id) => {
        ...
        if (proceed) {
            fetch(`https://arcane-headland-51224.herokuapp.com/booking/${id}`, {
                method: "DELETE",
            })
                .then((res) => res.json())
                .then((data) => {
    ...
    const handleStatus = (id) => {
        fetch(`https://arcane-headland-51224.herokuapp.com/hotels/${id}`)
            .then((res) => res.json())
            .then((data) => {
                // console.log(data);
                setHotel(data);
