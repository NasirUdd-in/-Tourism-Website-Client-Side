...
const Home = () => {
    ...
    useEffect(() => {
        fetch("https://arcane-headland-51224.herokuapp.com/hotels")
            .then((res) => res.json())
        ...
        <section className="home-page">
            <div className="container">
                <div className="row banner-content">
                    <div className="col-lg-6">
                        <div className="banner">
                            <h1>Holiday, Hotel & Enjoyment</h1>
                            <p>
                                Find your next holiday on 72 cool packages ! With Nasir Agency, booking
                    ...
                    <div className="col-lg-6 banner-img">
                        <img
                            src="https://i.ibb.co/VVF1hhw/travel-world.jpg"
                            alt="banner"
                        />
                    </div>
                </div>
                ...
                <div className="map-area">
                    <div className="row">
                        <div className="map-img col-lg-7">
                            <img
                                src="https://i.ibb.co/sJKLTW4/Productivity-hacks-portfolio-440x320.png"
                                alt=""
                            />
                        </div>
                ...
                <div className="feature-places">
                    ...
                    <p>
                        Popular places to stay that NAT recommends for you
                    </p>
                    <div className="row py-5 ctgs">
                        <div className="col-lg-8  ctgs">
                            <span className="btn btn-ctg active">Southeast Asia</span>
                ...
                <div className="choose">
                    <div className="row choose-container">
                        <div className="col-lg-5 choose-txt">
                            <img
                                src="https://i.ibb.co/qJFPkXw/11-Screenshot-3.png"
                                alt="logo"
                            />
                        ...
                        <div className="col-lg-6 choose-img">
                            <img
                                src="https://i.ibb.co/Hdj2RN0/Learning-how-to-think-clearly-portfolio-440x320.png"
                                alt=""
                            />
                        </div>
                    </div>
